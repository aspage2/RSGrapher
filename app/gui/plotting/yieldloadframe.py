...
class YieldLoadFrame(SamplePlotFrame):
    ...
    def __init__(self, parent):
        super().__init__(
            parent, "Load vs. Strain", annotation_id="yieldload_annotation"
        )
    ...
    def set_sample(self, sample):
        ...
        self.canvas.set_data(
            strain[sample.zero : sample.cutoff], load[sample.zero : sample.cutoff]
        )
        ...
        s = "Yield Load: {0:.{1}f} kips".format(
            load[intersect] / 1000.0, 3 - sample.precision
        )
